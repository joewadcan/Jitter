...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference("Pizza.count") do
      post pizzas_url, params: { pizza: { content: @pizza.content, user_id: @pizza.user_id } }
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { content: @pizza.content, user_id: @pizza.user_id } }
